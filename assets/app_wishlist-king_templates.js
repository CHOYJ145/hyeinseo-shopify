const templates = [
  ...
  },
  {
    ...
    template: `
      ...
      <button type="button" class="wk-button wk-button--{{ btn_action }} {{ addClass }}" title="{{ btn_title }}" data-wk-{{ btn_action }}-{{ scope }}="{{ targetId }}" style="border-bottom: solid 1px; margin: 0; padding: 3px 0 2px 0; font-size:14px;">
