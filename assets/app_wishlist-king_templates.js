const templates = [
  ...
  // },
  {
    ...
    template: `
      ...
      <button type="button" class="wk-button wk-button--{{ btn_action }} {{ addClass }}" title="{{ btn_title }}" data-wk-{{ btn_action }}-{{ scope }}="{{ targetId }}" style="margin: 0; padding: 0; font-size:14px;">
